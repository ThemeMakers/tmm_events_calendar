...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <ul style="display: <?php echo(in_array($event_repeating, $week_repeatings_array) ? 'block' : 'none') ?>;"
                id="event_week_days">
                ...
                <?php foreach ($week_days_array as $key => $value) : ?>
                    <li><label><input autocomplete="off" type="checkbox"
                                      value="<?php echo esc_attr($key); ?>" <?php if (is_array($event_repeating_week)) echo(in_array($key, $event_repeating_week) ? 'checked' : '') ?>
                                      name="event_repeating_week[]"/>&nbsp;<?php echo esc_html($value); ?></label><br/>
                    </li>
                <?php endforeach; ?>
    ...
    <tr>
        ...
        <td>
            <input autocomplete="off" type="text" value="<?php echo esc_attr($event_date); ?>" id="event_date"
    ...
    <tr>
        ...
        <td>
            <input autocomplete="off" type="text" value="<?php echo esc_attr($event_end_date); ?>" id="event_end_date"
                   name="event_end_date" readonly=""/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input id="event_allday" type="hidden" name="event_allday" autocomplete="off"
                   value="<?php echo($event_allday == '1' ? '1' : '0') ?>"/><br/>
            <input id="event_allday_cb" type="checkbox"
                   autocomplete="off" <?php echo($event_allday == 1 ? 'checked' : ''); ?> /><br/>
        </td>
    </tr>
    ...
    <tr class="event_time_wrapper">
        ...
        <td>
            <select name="event_end_hh" id="event_end_hh" class="event_time_select"
                    autocomplete="off"<?php echo $disabled; ?>>
                <?php for ($i = 0; $i <= 23; $i++): ?>
                    <option value="<?php echo $i ?>" <?php echo($event_end_hh == $i ? 'selected' : '') ?>><?php echo($i < 10 ? "0" . $i : $i); ?></option>
                <?php endfor; ?>
            </select>&nbsp;:&nbsp;
            <select name="event_end_mm" id="event_end_mm" class="event_time_select"
                    autocomplete="off"<?php echo $disabled; ?>>
                <?php for ($i = 0; $i <= 55; $i += 5): ?>
    ...
    <tr>
        <th colspan="2">
            <h3><?php _e('Event Organizer Info', TMM_EVENTS_PLUGIN_TEXTDOMAIN); ?>
                <hr>
            </h3>
        </th>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_organizer_phone); ?>" id="event_organizer_phone"
                   name="event_organizer_phone" autocomplete="off" style="display:inline-block;width: 50%;"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_organizer_website); ?>" id="event_organizer_website"
                   name="event_organizer_website" autocomplete="off" style="display:inline-block;width: 50%;"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_organizer_name); ?>" id="event_organizer_name"
                   name="event_organizer_name" autocomplete="off" style="display:inline-block;width: 50%;"/>
        </td>
    </tr>

    <tr>
        <th colspan="2">
            <h3><?php _e('Event Venue', TMM_EVENTS_PLUGIN_TEXTDOMAIN); ?>
                <hr>
            </h3>
        </th>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_place_phone); ?>" id="event_place_phone"
                   name="event_place_phone" autocomplete="off" style="display:inline-block;width: 50%;"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_place_website); ?>" id="event_place_website"
                   name="event_place_website" autocomplete="off" style="display:inline-block;width: 50%;"/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_place_address); ?>" id="event_place_address"
                   name="event_place_address" autocomplete="off" style="display:inline-block;width: 79%;"/>&nbsp;
            <a class="repeatable-add button" style="display: inline-block;" href="#"
               id="set_event_place"><?php _e('Set Location', TMM_EVENTS_PLUGIN_TEXTDOMAIN); ?></a><br/>
            <br/>
            <?php
    ...
    <tr>
        ...
        <td>
            <input id="hide_event_place" type="hidden" name="hide_event_place" autocomplete="off"
                   value="<?php echo($hide_event_place == '1' ? '1' : '0') ?>"/><br/>
            <input id="hide_event_place_cb" type="checkbox"
                   autocomplete="off" <?php echo($hide_event_place == 1 ? 'checked' : ''); ?> /><br/>
        </td>
    </tr>
    <tr>
        <th style="width:25%">
    ...
    <tr>
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_map_latitude); ?>" id="event_map_latitude"
                   name="event_map_latitude" autocomplete="off"/><br/>
        </td>
    </tr>
    <tr>
        <th style="width:25%">
        ...
        <td>
            <input type="text" value="<?php echo esc_attr($event_map_longitude); ?>" id="event_map_longitude"
                   name="event_map_longitude" autocomplete="off"/><br/>
        </td>
    </tr>
    </tbody>
</table>
...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        jQuery(function () {
            ...
            jQuery(document.body).on('click', '.ui-datepicker-current', function (e) {
                e.preventDefault();
            ...
            jQuery(".event_time_select").on('change', function () {
                check_date_errors();
            });

            jQuery(document.body).on('click', '#hide_event_place_cb', function (e) {
                e.preventDefault();
            ...
            jQuery(document.body).on('click', '#event_allday_cb', function (e) {
                e.preventDefault();
                if (jQuery(this).is(':checked')) {
